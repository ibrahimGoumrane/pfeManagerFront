    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="text-pfebrand hover:bg-pfebrand/10 hover:text-pfebrand/80 cursor-pointer"
        >
      ...
      <DialogContent className="sm:max-w-md border border-pfebrand/20 shadow-md shadow-pfebrand/5">
        <DialogHeader className="border-b border-pfebrand/10 pb-4">
          <DialogTitle className="text-pfebrand/90 text-xl">
            Edit User
          </DialogTitle>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="admin" className="text-pfebrand/70">
                    Admin
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem
                    ...
                    className="text-pfebrand border-pfebrand/30 focus:ring-pfebrand/20 data-[state=checked]:bg-pfebrand data-[state=checked]:text-white"
                  />
                  <Label htmlFor="user" className="text-pfebrand/70">
                    User
                  </Label>
                </div>
              </RadioGroup>
