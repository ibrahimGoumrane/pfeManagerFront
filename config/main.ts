...
const PRODUCTION_ADDRESS = "https://walrus-app-65k3h.ondigitalocean.app/api";
...
export const PRODUCTION_IMAGE = `${NEXT_PUBLIC_IMAGE_PROTOCOL}://${NEXT_PUBLIC_IMAGE_HOSTNAME}/`;
